...
#######################################################################
#  This file is generated by a routine inside !ntoolkit, for us  .    #
#                                                                     #
...
#                                                                     #
#  !ntoolkit.config.py generated: """ + timestamp + """               #
#                                                                     #
#######################################################################
CONFIG_DATE='""" + timestamp + """'\n""")
    ...
    new_config.close()
    sleep(1)
    sys.path.append("/etc/!ntoolkit")
    from set_config import CONFIG_DATE as verify
    print_info("New !ntoolkit.config.py file generated on: %s" % timestamp)
    ...
    print_status("!ntoolkit is using the new config, no need to restart")
    # return_continue()
