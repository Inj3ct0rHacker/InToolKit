...
# open set_config
apache_check = open("/etc/!ntoolkit/!ntoolkit.config", "r").readlines()
...
if exploit == "exploit/windows/fileformat/adobe_pdf_embedded_exe" or exploit == "exploit/windows/fileformat/adobe_pdf_embedded_exe_nojs":
    print_info(
        "Default payload creation selected. !ntoolkit will generate a normal PDF with embedded EXE.")
    print("""
    ...
    if choicepdf == '1':
        ...
        if inputpdf == "":
            # change to default !ntoolkit pdf
